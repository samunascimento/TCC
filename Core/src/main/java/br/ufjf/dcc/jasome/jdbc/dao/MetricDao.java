...
public class MetricDao {
    ...
    public ArrayList<PackageClass> selectClassName(String nameProject) throws SQLException {
        PreparedStatement stmt = null;
        ...
        String sql = "select distinct pk.packagename ,c.classname \n" +
                    "from tb_projectmetrics p\n" +
                    "inner join tb_project_version pv\n" +
                    "on p.id = pv.project_id \n" +
                    "inner join tb_version_package vp\n" +
