...
//                int nmirID = resultSet.getInt("nmirID");
//                int cfID = resultSet.getInt("cfID");
//                int pfID = resultSet.getInt("pfID");
//                int aifID = resultSet.getInt("aifID");
//                int ahID = resultSet.getInt("ahID");
//                int ahfID = resultSet.getInt("ahfID");
//                int lcomID = resultSet.getInt("lcomID");
//                int nodeID = resultSet.getInt("nodeID");
//                int nodaID = resultSet.getInt("nodaID");
//
//                if () {
//                    Metric 
//                }
//                aaIDMetric = metricDao.selectID(aaID);
...
//                Metric nmirIDMetric = metricDao.selectID(nmirID);
//                Metric cfIDMetric = metricDao.selectID(cfID);
//                Metric pfIDMetric = metricDao.selectID(pfID);
//                Metric aifIDMetric = metricDao.selectID(aifID);
//                Metric ahIDMetric = metricDao.selectID(ahID);
//                Metric ahfIDMetric = metricDao.selectID(ahfID);
//                Metric lcomIDMetric = metricDao.selectID(lcomID);
//                Metric nodeIDMetric = metricDao.selectID(nodeID);
//                Metric nodaIDMetric = metricDao.selectID(nodaID);
//
...
//                classMetrics.setNmir(nmirIDMetric);
//                classMetrics.setCf(cfIDMetric);
//                classMetrics.setPf(pfIDMetric);
//                classMetrics.setAif(aifIDMetric);
//                classMetrics.setAh(ahIDMetric);
//                classMetrics.setAhf(ahfIDMetric);
//                classMetrics.setLcom(lcomIDMetric);
//                classMetrics.setNode(nodeIDMetric);
//                classMetrics.setNoda(nodaIDMetric);
