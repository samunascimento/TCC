...
//    public ExecutionWindows(String command, String input) {
//        try {
...
//    }
    ...
    public CLIExecution ExecutionWindows(String command, String input, String directory ) {
        try {
            
            CLIExecution execution = new CLIExecution();
            p = Runtime.getRuntime().exec(makeArray(command),null,new File(directory));
            new OutputReader().start();
            new ErrorReader().start();
            p.waitFor();
           
            String num = getOutput();
