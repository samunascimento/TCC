// Generated from /home/joao_lima/Git/UFJF/Core/src/main/java/br/ufjf/dcc/gmr/core/mergenature/antlr4/grammars/csharp/CSharpParser.g4 by ANTLR 4.8
...
public class CSharpParser extends Parser {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"variant_type_parameter", "variance_annotation", "interface_signature", 
			"interface_base", "interface_body", "interface_member_declaration", "interface_accessors", 
			"enum_base", "enum_body", "enum_member_declaration", "enum_signature", 
			"global_attribute_section", "global_attribute_target", "attributes", 
			"attribute_section", "attribute_target", "attribute_list", "attribute", 
			"attribute_argument", "pointer_type", "fixed_pointer_declarators", "fixed_pointer_declarator", 
			"fixed_pointer_initializer", "fixed_size_buffer_declarator", "stackalloc_initializer", 
