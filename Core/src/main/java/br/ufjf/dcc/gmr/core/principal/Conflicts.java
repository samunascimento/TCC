...
public class Conflicts {
    ...
    public static void getConflicts(List<Formats> mergeList, String repository) throws LocalRepositoryNotAGitRepository, OptionNotExist, IOException, RepositoryNotFound, CheckoutError {

        String array[] = new String[2];
        String path;
        List<String> conflictsArchives = Git.statusUnmerged(repository);
        List<FileStatus> status = Git.status(repository);
    ...
    public static void getAreaConflicts(String filePath) {
