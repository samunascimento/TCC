 ...
 * @author luan
 */
public class SyntaxStructureConflictRegionSyntaxV1DAO {
    ...
    public SyntaxStructureConflictRegionSyntaxV1DAO(Connection connection) {
        this.connection = connection;
    }

    public boolean insert(int syntaxStructureID, int conflcitRegionID) throws SQLException {

        String sql = "INSERT INTO ConflictFile_MergeEvent_SyntaxV1 "
